// Composant "TextLoop" de la bibliothèque React Bits (reactbits.dev/text-animations/text-loop),
// copié tel quel (licence MIT, gratuit) — voir cahier des charges §7 « Composants visuels ».
// Ne pas renommer les props : ce sont celles du composant d'origine.
