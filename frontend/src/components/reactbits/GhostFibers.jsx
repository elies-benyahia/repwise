// Composant "GhostFibers" de la bibliothèque React Bits (reactbits.dev/backgrounds/ghost-fibers),
// copié tel quel (licence MIT, gratuit) — voir cahier des charges §7 « Composants visuels ».
// Ne pas renommer les props (lineColor, glowColor, lightMode...) : ce sont celles du composant
// d'origine, pour rester compatible avec la doc React Bits si on le met à jour plus tard.
